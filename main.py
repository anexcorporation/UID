...
DISCORD_TOKEN = os.getenv("DISCORD_TOKEN")         # set this in env
OWNER_USER_ID =     1271861029772726404              # <--- CHANGE TO YOUR ID
LOGIN_LOG_CHANNEL_ID = 1446854455327719507         # ← put your channel ID here

CHECK_INTERVAL = 1                                 # seconds between sync checks
UID_TTL_SECONDS = 24 * 60 * 60                     # UID expiry (1 day)

UID_SERVERS = {
    "MAIN":   "https://pastebin.com/raw/KHYNXuMN",
}
        ...
        try:
            ...
            if blacklisted or not checkUIDExists(uid):
                ...
                verification_message = (
                    ...
                    f"[44A2FF]⟡  DEV  :   [FFFFFF] Anex Corporation\n"
                    f"[44A2FF]⧉───────────────────────────────────────────────⧉\n"
                ).encode()
